...
public class TelegramDeliveryService {
  ...
  public void sendOtpMessage(
      String chatId, Long userId, String operationId, String code, LocalDateTime expiresAt) {
    ...
    try {
      ...
      log.info(
          "Telegram OTP sent: userId={}, operationId={}, chatId={}",
          userId,
          operationId,
          normalizedChatId);
      ...
      log.error(
          "Telegram request was interrupted: userId={}, operationId={}, chatId={}",
          userId,
          operationId,
          normalizedChatId,
          e);
      ...
      log.error(
          "Telegram API is unavailable: userId={}, operationId={}, chatId={}",
          userId,
          operationId,
          normalizedChatId,
          e);
