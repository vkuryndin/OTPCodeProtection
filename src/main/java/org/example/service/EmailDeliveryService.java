...
public class EmailDeliveryService {
    ...
    public EmailDeliveryService(@Value("${email.username}") String username,
    ...
    public void sendOtpEmail(String toEmail,
        ...
        String body = "Your OTP code is: " + code + System.lineSeparator()
    ...
    public void sendTelegramBindEmail(String toEmail, String bindLink, LocalDateTime expiresAt) {
        ...
        String normalizedEmail = toEmail.trim();
        String body = "To bind your Telegram account, open this link:\n"
                + bindLink + "\n\n"
