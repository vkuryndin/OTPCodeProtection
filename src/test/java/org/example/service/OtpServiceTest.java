...
class OtpServiceTest {
  ...
  @Mock private OtpConfigRepository otpConfigRepository;

  @Mock private OtpCodeRepository otpCodeRepository;

  @Mock private FileDeliveryService fileDeliveryService;

  @Mock private EmailDeliveryService emailDeliveryService;

  @Mock private TelegramDeliveryService telegramDeliveryService;

  @Mock private SmsDeliveryService smsDeliveryService;

  @Mock private UserRepository userRepository;

  @Mock private GenerateOtpRateLimitService generateOtpRateLimitService;
  ...
  class GenerateOtp {
    ...
    void shouldThrowRateLimitExceededException_whenGenerationLimitIsExceeded() {
      ...
      RateLimitExceededException exception =
          assertThrows(
              RateLimitExceededException.class, () -> otpService.generateOtp(userId, request));
      ...
      verifyNoInteractions(
          fileDeliveryService, emailDeliveryService, telegramDeliveryService, smsDeliveryService);
    }
    ...
    void shouldDeleteCreatedOtp_whenDeliveryFails() {
      ...
      RuntimeException exception =
          assertThrows(RuntimeException.class, () -> otpService.generateOtp(userId, request));
  ...
  class DeliveryRules {
    ...
    void shouldRejectMissingUserEmail() {
      ...
      IllegalArgumentException exception =
          assertThrows(
              IllegalArgumentException.class, () -> otpService.generateOtp(userId, request));
    ...
    void shouldRejectMissingOtpConfig() {
      ...
      NotFoundException exception =
          assertThrows(NotFoundException.class, () -> otpService.generateOtp(userId, request));
    ...
    void shouldRejectDeliveryTargetForEmail() {
      ...
      assertEquals(
          "Delivery target must not be provided for EMAIL channel", exception.getMessage());
    ...
    void shouldRejectDeliveryTargetForTelegram() {
      ...
      assertEquals(
          "Delivery target must not be provided for TELEGRAM channel", exception.getMessage());
  ...
  class ValidateOtp {
    ...
    void shouldRejectInvalidOrExpiredCode() {
      ...
      IllegalArgumentException exception =
          assertThrows(
              IllegalArgumentException.class, () -> otpService.validateOtp(userId, request));
    ...
    void shouldBlockAfterTooManyInvalidAttempts() {
      ...
      IllegalArgumentException blockedException =
          assertThrows(
              IllegalArgumentException.class, () -> otpService.validateOtp(userId, request));

      assertEquals(
          "Too many invalid OTP attempts. Try again later.", blockedException.getMessage());

      verify(otpCodeRepository, times(5))
          .consumeActiveCode(userId, "payment-validate-003", "654321");
    }
    ...
    void shouldClearFailedAttempts_afterSuccessfulValidation() {
      ...
      IllegalArgumentException firstException =
          assertThrows(
              IllegalArgumentException.class, () -> otpService.validateOtp(userId, wrongRequest));
      ...
      verify(otpCodeRepository, times(2))
          .consumeActiveCode(userId, "payment-validate-004", "000000");
